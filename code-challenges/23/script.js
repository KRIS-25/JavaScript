...
const pos = document.querySelector('.images');
...
const createImage = function (imgPath) {
  return new Promise(function (resolve, reject) {
    ...
    img.addEventListener('error', function () {
      reject(new Error('Image Path is incorrect'));
    });
  });
};

const setTime = function (seconds) {
...
const loadAll = async function (imgArr) {
  try {
    ...
    console.log(imgs); // This will return promises
